...
mu_sum_part2 = np.zeros([ndof,nt+1,PCE_u])
...
comm.Reduce(u_PCsum, mu_sum_part2, op=MPI.SUM, root=0)



if(ip == 0):

    part1 = sio.loadmat('./u_nisp_part1_mean')

    mu_sum_part1 = part1['u_nisp_part1_mean']
