...
quadpath = "./quadData/d3l1/qdpts.dat"
weightpath = "./quadData/d3l1/wghts.dat"
...
if(ip ==0):
    ...
    remnQD = nQdpts%NP
    print('remaining QD pts is ', remnQD)
else:
    chunks = None
    NP = None
    remnQD = None
...
comm.Reduce(u_PCsum, mu_sum_part1, op=MPI.SUM, root=0)


spath = './u_nisp_part1_mean.mat'
sio.savemat(spath, {'u_nisp_part1_mean':mu_sum_part1})
